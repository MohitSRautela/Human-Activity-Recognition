...
# Take video file as input if given, else turn on webcam
...
while True:
    ...
    # Break when no frame is grabbed (or end of the video)
    if not grabbed:
    ...
    # Manipulate the image blob for the pre-trained model
